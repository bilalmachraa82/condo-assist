...
import EmailPendencies from "./pages/EmailPendencies";
        ...
        <TooltipProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              />
              <Route 
                path="/follow-ups/configuracao" 
                element={
                  <ProtectedRoute>
                    <DashboardLayout><FollowUpSettings /></DashboardLayout>
                  </ProtectedRoute>
                } 
              />
              <Route 
                path="/pendencias-email" 
                element={
                  <ProtectedRoute>
                    <DashboardLayout><EmailPendencies /></DashboardLayout>
                  </ProtectedRoute>
                } 
              />
              <Route 
              ...
              <Route 
                ...
                element={
                  <ProtectedRoute>
                    <DashboardLayout><Seguros /></DashboardLayout>
                  </ProtectedRoute>
                } 
              />
              ...
              <Route path="/mcp-setup" element={<ProtectedRoute><DashboardLayout><McpSetup /></DashboardLayout></ProtectedRoute>} />
