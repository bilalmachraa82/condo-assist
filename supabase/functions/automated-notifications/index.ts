  ...
  try {
    ...
    switch (type) {
      case "assignment":
        ...
        recipientEmail = assistance.suppliers.email;
          ...
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="padding: 30px; background: #f8f9fa;">
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="https://luvimg.com/portal-fornecedor" style="background: #667eea; color: white; padding: 15px 30px; text-decoration: none; border-radius: 5px; font-weight: bold;">
        ...
        emailContent = `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="padding: 30px; background: #f8f9fa;">
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="https://luvimg.com/portal-fornecedor" style="background: #ffc107; color: #333; padding: 15px 30px; text-decoration: none; border-radius: 5px; font-weight: bold;">
                  Responder Agora
                </a>
              </div>
          ...
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="padding: 30px; background: #f8f9fa;">
              ...
              <div style="background: white; padding: 20px; border-radius: 8px; border-left: 4px solid #dc3545;">
                <h3 style="color: #333; margin-top: 0;">${assistance.title}</h3>
                <p><strong>Fornecedor:</strong> ${assistance.suppliers?.name || 'N/A'}</p>
                <p><strong>Email:</strong> ${assistance.suppliers?.email || 'N/A'}</p>
