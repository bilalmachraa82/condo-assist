...
-- Fix intervention_types table - ensure urgency_level uses correct enum values
UPDATE public.intervention_types 
SET urgency_level = 'normal'::assistance_priority 
WHERE urgency_level NOT IN ('low', 'normal', 'high', 'urgent');