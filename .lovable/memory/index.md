...
- [External API Access](mem://features/external-api-access) — agent-api edge function with 10 REST endpoints, dual auth, rate limiting, idempotency, condominium_contacts table
